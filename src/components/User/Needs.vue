<template>
  <div>
    <el-table :data="needsInfo" border style="width: 100%">
        ...
        <template slot-scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            ...
            <el-form-item label="所有者ID">
              <span>{{ props.row.keeper._id || 'null' }}</span>
            </el-form-item>
            <el-form-item label="用户名">
              <span>{{ props.row.keeper.username || 'null' }}</span>
            </el-form-item>
      ...
      <el-table-column prop="keeper.username" label="所有者">
      </el-table-column>
...
<script>
import { getNeedsInfo } from "@/axios/api";
//导出组件
export default {
  data() {
    return {
